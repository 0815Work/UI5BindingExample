sap.ui.define([
	...
	return Controller.extend("UI5BindingExample.controller.App", {
		...
		productListFactory : function (sId, oContext) {
			...
			//This item is out of stock and discontinued *and* discontinued?
			if (oContext.getProperty("UnitsInStock") === 0 && oContext.getProperty("Discontinued")) {
				//Yup, so use a StandartListItem
			...
			// Set item active (so it is clickable) and attach the press event handler for showing the details
